...
Venue: arXiv:2511.01386v1 [cs.CL]

Key Takeaway (TL;DR): RAGSmith is a framework that uses a genetic search to automatically find the best combination of RAG components (retrieval, ranking, etc.) for a specific dataset, resulting in a much better "end-to-end" system than manually tuning parts in isolation.
